package lovera.estudos.tests.box2d;

/**
 * Created by santi_000 on 22/02/2017.
 */
...
public class ApplyForce extends Box2DTest {
    ...
    protected void createWorld (World world) {
...

        {
            ...
            shape.set(new Vector2(-20, -19), new Vector2(-20, 10));
            ...
            shape.set(new Vector2(-20, -19), new Vector2(20, -19));
            ground.createFixture(sd);
